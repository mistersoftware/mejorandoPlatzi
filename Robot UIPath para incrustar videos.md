...
## 1 Usar UIPath para buscar enlaces a youtube e incrustarlos como otro comentario

<!--
párrafo corto que explica qué estas proponiendo
-->
La idea se basa en algo creado por espanolito (un profesor) para automatizar las respuestas. La idea es usarlo para que identifique mensajes que contienen enlaces a youtube y vimeo e incrustarlos como una respuesta.
...
-->
Evitar la rupura en la experiencia de usuario que ocurre cuando hay que salir de la plataforma a consumir contenido externo.
...
Tomar el curso de UIPath y apoyarme en el profesor que origino la idea.
...
-->
Se puede medir y comparar el porcentaje de salida de usuarios antes y despues de la implementación.
...
-->
Alguna politica interna que no conozca de Platzi o Youtube que lo prohiba.
...
-->
Esta es la primera solución que se me ocurre al tema, aunque también es posible lograrlo nativamente desde el propio pulse editor.
...
<!--
 ...
 -->
Es posible que este feature tenga un impacto economico para Platzi por el aumento de llamadas a la API de youtube.
...
-->
Si se logra incluir la opción de pantalla completa dentro de pulse editor, ¿el impacto considero seria mayor?
