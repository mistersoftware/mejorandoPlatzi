...
## 1 Menciones y notificaciones

<!--
párrafo corto que explica qué estas proponiendo
-->
Las menciones deberian ser notificadas.
## 2 Motivación
...
-->
Cuando un usuario usa una mencion del tipo @otrousuario, el otro usuario no es notificado y se pierden interacciones valiosas.
