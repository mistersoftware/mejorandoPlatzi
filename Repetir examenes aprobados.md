...
## 1 Repetir examenes aprobados

<!--
párrafo corto que explica qué estas proponiendo
-->
Habilitar la opcion de repetir un examen ya aprobado cada 6 horas.
...
-->
Aprendizaje por repeticion espaciada.
...
El estudiante que mejora su resultado previo, obtendra un incentivo en puntos. Podra practicar cuantas veces guste sin generar puntos para no abusar del sistema.
